...
export const TEAM_STAGES = ["prepare_prompt", "provider_turn", "synthesis", "complete"] as const;
export type TeamStage = (typeof TEAM_STAGES)[number];

export const TEAM_PROGRESS_STATUSES = ["started", "completed", "failed"] as const;
