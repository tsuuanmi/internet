...
const BROWSER_TEAM_GUIDANCE = [
	...
	"For one simple debate, call internet_team directly. Providers speak sequentially in the configured order once per round (default 2, maximum 4). By default the last provider then synthesizes the full current-call debate into one final answer.",
