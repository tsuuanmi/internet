import type { WorkflowExternalEventWait, WorkflowExternalEventWaitContract, WorkflowTimer, WorkflowTimerContract } from "#internet/workflow/awaitables/types";
...
export type WorkflowNeedMaterialization = WorkflowWorkItemMaterialization | WorkflowPendingActionMaterialization | WorkflowTimerMaterialization | WorkflowExternalEventMaterialization;
