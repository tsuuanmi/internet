...
export declare function currentWorkflowArtifactIds(artifacts: readonly WorkflowArtifact[]): ReadonlySet<string>;
export declare function workflowInputBundleIsCurrent(bundle: WorkflowInputBundle, artifacts: readonly WorkflowArtifact[]): boolean;
