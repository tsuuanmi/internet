export declare const WORKFLOW_PHASES: readonly ["RESEARCH", "WRITER", "REVIEW", "DONE"];
export type WorkflowPhase = (typeof WORKFLOW_PHASES)[number];
export declare const WORKFLOW_LIFECYCLES: readonly ["RUNNING", "RECOVERING", "BLOCKED", "COMPLETED", "CANCELLED"];
export type WorkflowLifecycle = (typeof WORKFLOW_LIFECYCLES)[number];
export declare const WORKFLOW_NODE_KINDS: readonly ["TEAM_MEMBER", "TEAM_SYNTHESIS", "RESEARCH_HANDOFF_GATE", "WRITER_IMPLEMENTATION", "REVIEW_HANDOFF_GATE", "WRITER_REMEDIATION"];
export type WorkflowNodeKind = (typeof WORKFLOW_NODE_KINDS)[number];
export declare const WORKFLOW_NODE_STATES: readonly ["WAITING", "READY", "RUNNING", "RECOVERING", "COMPLETED", "FAILED", "CANCELLED"];
...
export declare const WORKFLOW_PROVIDER_STATES: readonly ["NAVIGATING", "THINKING", "STREAMING", "CONFIRMATION_REQUIRED", "STALLED", "RATE_LIMITED", "AUTH_REQUIRED", "BROWSER_DEAD", "COMPLETED"];
