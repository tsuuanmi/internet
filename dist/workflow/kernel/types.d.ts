...
export declare const WORKFLOW_RUN_SCHEMA: "@tsuuanmi/internet-workflow-run";
export declare const WORKFLOW_ARTIFACT_SCHEMA: "@tsuuanmi/internet-workflow-artifact";
export declare const WORKFLOW_WORK_ITEM_SCHEMA: "@tsuuanmi/internet-workflow-work-item";
