...
export declare const WORKFLOW_TIMER_SCHEMA: "@tsuuanmi/internet-workflow-timer";
export declare const WORKFLOW_EXTERNAL_EVENT_SCHEMA: "@tsuuanmi/internet-workflow-external-event";
export declare const WORKFLOW_EXTERNAL_EVENT_WAIT_SCHEMA: "@tsuuanmi/internet-workflow-external-event-wait";
export declare const WORKFLOW_TIMER_STATES: readonly ["PENDING", "FIRED", "CANCELLED"];
export type WorkflowTimerState = (typeof WORKFLOW_TIMER_STATES)[number];
export declare const WORKFLOW_EXTERNAL_EVENT_WAIT_STATES: readonly ["WAITING", "MATCHED", "CANCELLED"];
