...
export const WORKFLOW_NODE_RESULT_SCHEMA = "@tsuuanmi/internet-workflow-node-result";
...
export function hashWorkflowNodePayload(payload) {
    return createHash("sha256").update(payload, "utf8").digest("hex");
}
export function workflowNodeResultId(input) {
...
export function parseWorkflowNodeResult(value) {
    ...
    if (typeof value.payload !== "string")
        throw new Error("invalid workflow node result payload");
    ...
    if (value.resultId !== expectedId)
        throw new Error("workflow node result id does not match logical identity");
    return value;
}
...
//# sourceMappingURL=node-result-store.js.map