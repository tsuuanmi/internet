...
export function resolveBrowserConfig(raw) {
    ...
    return {
        ...
        maxConcurrentTurnsPerProvider: asPositiveInteger(input.maxConcurrentTurnsPerProvider, DEFAULT_CONFIG.maxConcurrentTurnsPerProvider, "maxConcurrentTurnsPerProvider"),
