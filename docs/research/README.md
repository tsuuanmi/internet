...
Research may support a proposal or decision. It changes production behavior only after promotion into the appropriate current requirements, architecture/design/reference, source, tests, and validation.
